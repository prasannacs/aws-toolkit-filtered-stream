...
async function createTables() {
    ...
    let sql_tweets = "CREATE table tweets (tweet_id VARCHAR(100) NOT NULL, tweet_text VARCHAR(2000) NOT NULL, author_id VARCHAR(100), conversation_id VARCHAR(100), created_at DATETIME, geo_place_id VARCHAR(50), in_reply_to_user_id VARCHAR(50), lang VARCHAR(10), like_count INT, reply_count INT, quote_count INT, retweet_count INT, possibly_sensitive BOOLEAN, reply_settings VARCHAR(20), source VARCHAR(150), tweet_url VARCHAR(100), PRIMARY KEY (tweet_id), category VARCHAR(50), subcategory VARCHAR(50))"
...
module.exports = { createRedShiftCluster, createNamespaceCommand, createTables, createWorkgroup, getWorkgroup, insertTweetData, insertTweets, copyCommand };
